      ...
      <section className="relative min-h-[65vh] md:h-[80vh] flex items-center justify-center overflow-hidden hero-readable">
        ...
        <div className="relative z-10 text-center px-6">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1.2 }}>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-8xl lg:text-[10rem] font-black font-['Outfit'] hero-video-title tracking-tighter mb-8 uppercase leading-none text-ink-gradient shadow-2xl">
              What's <span className="text-gradient">On.</span>
            </h1>
            <p className="text-xl md:text-2xl hero-video-subtitle font-medium max-w-3xl mx-auto leading-relaxed hero-video-glass p-10 rounded-[3rem] text-[color:var(--text-dim)] shadow-xl">
      ...
      <section className="py-24 md:py-40 px-6 md:px-12 bg-page relative z-10">
        <div className="max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-10">
            <div>
              <p className="text-[10px] font-black tracking-[0.6em] uppercase text-accent mb-6">Live Calendar</p>
              <h2 className="text-4xl md:text-7xl font-black font-['Outfit'] text-ink-gradient uppercase tracking-tighter leading-none">Upcoming <span className="text-gradient">Experiences.</span></h2>
            </div>
            ...
            {visibleEvents.map((event, i) => (
              ...
              >
                ...
                <div className="p-10 md:p-12 flex-1 flex flex-col">
                  <h3 className="text-3xl font-black font-['Outfit'] text-ink-gradient mb-8 uppercase tracking-tighter group-hover:text-accent transition-colors leading-none">{event.title}</h3>
                  ...
                  <div className="mt-auto pt-10 border-t border-[var(--border)]">
                    <Link to="/opportunity/venue-rotunda" className="flex items-center justify-between w-full group/btn">
                      <span className="text-[10px] font-black tracking-[0.4em] uppercase text-accent group-hover:tracking-[0.5em] transition-all">Experience Details</span>
      ...
      <section className="py-24 px-6 md:px-12 bg-page relative virtual-section">
        <div className="max-w-[1400px] mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full border border-[var(--border)] glass-pane mb-12">
             ...
             <span className="text-[10px] font-black tracking-[0.5em] uppercase text-accent">Premium Partnerships</span>
          </div>
          <h2 className="text-5xl md:text-8xl font-black font-['Outfit'] text-ink-gradient mb-24 uppercase tracking-tighter leading-none">
            The Nation's Most <br/><span className="text-gradient">Celebrated Stage.</span>
          </h2>
