...
const venues = [
  {
    name: "The Rotunda",
    desc: "The iconic central gathering space for up to 10,000 guests.",
    icon: Building2,
  },
  {
    name: "Nickelodeon Universe",
    desc: "Private theme park rentals for epic corporate events.",
    icon: Music,
  },
  {
    name: "Concert Spaces",
    desc: "Multiple stages for live entertainment and comedy.",
    icon: Mic,
  },
  {
    name: "Level 4 Expo",
    desc: "Modular convention space for B2B trade shows.",
    icon: Presentation,
  },
];
...
export function Venues() {
  ...
  return (
    <div className="page-wrapper bg-page transition-colors duration-500">
      <section
        ref={containerRef}
        className="relative h-[150vh] lg:h-[200vh] pt-0 virtual-section"
      >
          ...
          <div className="relative z-10 w-full h-full flex flex-col items-center justify-center text-center px-8 pointer-events-none">
            ...
            >
              <div className="flex items-center justify-center gap-4 mb-10">
                ...
                <p className="text-accent text-[11px] font-black tracking-[0.6em] uppercase">
                  The Venue Registry
                </p>
                <div className="w-12 h-px bg-accent" />
              </div>
              ...
              <p className="text-xl md:text-3xl text-[color:var(--text-dim)] max-w-3xl mx-auto font-medium leading-relaxed italic border-l-4 border-accent pl-10 text-left">
                12 customizable environments for launches, culture, and business
                events across Mall of America’s premium core.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 md:gap-12">
            ...
            <motion.div
              ...
              className="relative rounded-[2.5rem] md:rounded-[3.5rem] overflow-hidden group shadow-2xl border border-[var(--border)] lighting-card min-h-[450px] md:min-h-[600px] scroll-reveal compositor-layer"
            >
              <img
                src={moaEvent}
                alt="The Rotunda"
              ...
              <div className="absolute bottom-0 left-0 p-8 md:p-16">
                ...
                <h2 className="text-4xl md:text-7xl font-black font-['Outfit'] text-ink-gradient mb-4 md:mb-6 uppercase tracking-tight">
                  The Rotunda
                </h2>
                <p className="text-[color:var(--text-dim)] text-base md:text-lg mb-6 md:mb-10 max-w-sm font-medium leading-relaxed">
                  The heartbeat of Mall of America. Unmatched visibility for
                  major brand activations and global cultural summits.
                </p>
                <Link to="/opportunity/venue-rotunda" className="btn-luxe">
                  Book Venue
                </Link>
              </div>
            </motion.div>
            ...
            <div className="flex flex-col gap-4 md:gap-8 mt-8 lg:mt-0">
              <div className="pb-4 md:pb-6 border-b border-[var(--border)]">
                <h3 className="text-accent text-[10px] font-black tracking-[0.5em] uppercase">
                  Executive Spaces
                </h3>
              </div>
                ...
                <Link to="/opportunity/venue-concert-spaces" key={i}>
                  ...
                  >
                    <div className="flex items-center gap-4 md:gap-8">
                      ...
                      <div>
                        <h3 className="text-xl md:text-2xl font-black font-['Outfit'] text-ink-gradient uppercase mb-1 md:mb-2 leading-none tracking-tight">
                          {v.name}
                        </h3>
                        <p className="text-[color:var(--text-dim)] font-medium text-xs md:text-sm leading-relaxed max-w-[200px] md:max-w-none">
                          {v.desc}
                        </p>
                      </div>
                    </div>
