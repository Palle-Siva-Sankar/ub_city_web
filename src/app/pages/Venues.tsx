      ...
      <section className="py-16 md:py-32 px-4 md:px-12 bg-page relative z-20 virtual-section">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 md:gap-12">
            ...
            <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative rounded-[2.5rem] md:rounded-[3.5rem] overflow-hidden group shadow-2xl border border-[var(--border)] lighting-card min-h-[450px] md:min-h-[600px] scroll-reveal compositor-layer">
