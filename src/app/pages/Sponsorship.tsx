        ...
        <div className="max-w-[1400px] mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.1, margin: "-10px" }} transition={{ delay: i * 0.1 }} className="glass-pane lighting-card rounded-[4rem] p-12 md:p-20 text-left relative overflow-hidden group border border-[var(--border)]">
      ...
      <section className="py-24 md:py-32 bg-page px-6 md:px-12 relative z-10 overflow-hidden">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.1, margin: "-10px" }} transition={{ delay: i * 0.1 }}
