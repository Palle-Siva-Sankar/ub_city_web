                ...
                {[
                  ...
                  <div key={i}>
                    ...
                    <div className="w-full h-3 bg-page-bg-alt rounded-full overflow-hidden border border-[var(--border)]">
                      <motion.div initial={{ width: 0 }} whileInView={{ width: `${item.pct}%` }} viewport={{ once: false, amount: 0.1, margin: "-10px" }} transition={{ duration: 1, delay: 0.5 }} className="h-full bg-accent" />
                    </div>
                  </div>
                ))}
              </div>
