...
export const DINING_VARIETIES: DiningVariety[] = [
  { slug: "rainforest-skewers", name: "Rainforest Safari Skewers", cuisine: "American Bistro", price: 26, prepTime: "22 mins", image: "https://images.unsplash.com/photo-1544025162-d76694265947?q=80&w=900", description: "Grilled beef and chicken skewers with fresh seasonal vegetables and spicy glaze." },
  ...
  { slug: "cajun-salmon", name: "Cajun Seared Salmon", cuisine: "Seafood", price: 23, prepTime: "20 mins", image: "https://images.unsplash.com/photo-1467003909585-2f8a72700288?q=80&w=900", description: "Fresh Atlantic salmon with cajun spices, roasted asparagus, and lemon butter." },
